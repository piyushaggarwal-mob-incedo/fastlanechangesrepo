...
@property (nonatomic, assign) IBInspectable CGFloat selectedDotWidth;
@property (nonatomic, assign) IBInspectable CGFloat dotWidth;

@property (nonatomic, assign) IBInspectable CGFloat dotSpacing;
@property (nonatomic) SFPageControlAlignment alignment;
@property (nonatomic) SFPageControlVerticalAlignment verticalAlignment;
