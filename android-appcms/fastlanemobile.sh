...
if [ "$IS_APP_SUCCESS" -eq "0" ]
        ...
        aws s3 cp ./AppCMS/build/outputs/apk/mobileNonKiswe/release/AppCMS-mobile-nonkiswe-release.apk s3://${19}/$1/build/android/
        ...
        if [ "$IS_APP_ONPLAYSTORE" -eq "0" ]
                ...
                fastlane android supply_onplaystore package_name:$6 track:${10} json_key_file:./googleplay_android.json apk_path:./AppCMS/build/outputs/apk/mobile/release/AppCMS-mobile-nonkiswe-release.apk buildid:${17} posturl:$POST_URL mySlackUrl:${24} myAppName:${4} myAppVersion:${3} myEmailId:${23} myBuildId:${17}
