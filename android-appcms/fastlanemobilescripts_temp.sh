...
fastlane android slackSendMessage my_slack_msg:"${4} -> ANDROID BUILD SUCCESSFULLY STARTED. BUILD-ID -> ${17}. VERSION-NUMBER -> ${3}" my_user_name:"Viewlift fastlane"
...
aws s3 cp s3://appcms-config/$1/build/android/resource/drawable-xhdpi ./AppCMS/src/main/res/drawable-xhdpi/ --recursive
postBuildStatus ${17} $POST_URL "DOWNLOADING_RESOURCES" "No ERROR" "Downloading the build drawable resources" 7 " " 0
aws s3 cp s3://appcms-config/$1/build/android/resource/drawable-xxxhdpi ./AppCMS/src/main/res/drawable-xxxhdpi/ --recursive
postBuildStatus ${17} $POST_URL "DOWNLOADING_RESOURCES" "No ERROR" "Downloading the build drawable resources" 8 " " 0
aws s3 cp s3://appcms-config/$1/build/android/resource/drawable-xxhdpi ./AppCMS/src/main/res/drawable-xxhdpi/ --recursive
...
fastlane android slackSendMessage my_slack_msg:"${4} -> ANDROID DOWNLOADING RESOURCES AND METADATA. BUILD-ID -> ${17}. VERSION-NUMBER -> ${3}" my_user_name:"Viewlift fastlane"


aws s3 cp s3://appcms-config/$1/build/android/resource/mipmap-hdpi ./AppCMS/src/main/res/mipmap-hdpi/ --recursive
aws s3 cp s3://appcms-config/$1/build/android/resource/mipmap-hdpi ./AppCMS/src/mobile/res/mipmap-hdpi/ --recursive
postBuildStatus ${17} $POST_URL "DOWNLOADING_RESOURCES" "No ERROR" "Downloading the build mipmap resources" 10 " " 0

aws s3 cp s3://appcms-config/$1/build/android/resource/mipmap-mdpi ./AppCMS/src/main/res/mipmap-mdpi/ --recursive
aws s3 cp s3://appcms-config/$1/build/android/resource/mipmap-mdpi ./AppCMS/src/mobile/res/mipmap-mdpi/ --recursive
postBuildStatus ${17} $POST_URL "DOWNLOADING_RESOURCES" "No ERROR" "Downloading the build mipmap resources" 11 " " 0

aws s3 cp s3://appcms-config/$1/build/android/resource/mipmap-xhdpi ./AppCMS/src/main/res/mipmap-xhdpi/ --recursive
aws s3 cp s3://appcms-config/$1/build/android/resource/mipmap-xhdpi ./AppCMS/src/mobile/res/mipmap-xhdpi/ --recursive
postBuildStatus ${17} $POST_URL "DOWNLOADING_RESOURCES" "No ERROR" "Downloading the build mipmap resources" 12 " " 0

aws s3 cp s3://appcms-config/$1/build/android/resource/mipmap-xxhdpi ./AppCMS/src/main/res/mipmap-xxhdpi/ --recursive
aws s3 cp s3://appcms-config/$1/build/android/resource/mipmap-xxhdpi ./AppCMS/src/mobile/res/mipmap-xxhdpi/ --recursive
postBuildStatus ${17} $POST_URL "DOWNLOADING_RESOURCES" "No ERROR" "Downloading the build mipmap resources" 13 " " 0

aws s3 cp s3://appcms-config/$1/build/android/resource/mipmap-xxxhdpi ./AppCMS/src/main/res/mipmap-xxxhdpi/ --recursive
aws s3 cp s3://appcms-config/$1/build/android/resource/mipmap-xxxhdpi ./AppCMS/src/mobile/res/mipmap-xxxhdpi/ --recursive
...
if [ "$IS_APP_ONPLAYSTORE" -eq "0" ]
        ...
        fastlane android slackSendMessage my_slack_msg:"${4} -> ANDROID UPDATING VERSION PROPERTIES OF THE APPLICATION. BUILD-ID -> ${17}. VERSION-NUMBER -> ${3}" my_user_name:"Viewlift fastlane"
...
if [ "$IS_APP_SUCCESS" -eq "0" ]
        ...
        aws s3 cp ./AppCMS/build/outputs/apk/mobile/release/AppCMS-mobile-release.apk s3://appcms-config/$1/build/android/
        ...
        if [ "$IS_APP_ONPLAYSTORE" -eq "0" ]
                ...
                fastlane android supply_onplaystore package_name:$6 track:${10} json_key_file:./googleplay_android.json apk_path:./AppCMS/build/outputs/apk/mobile/release/AppCMS-mobile-release.apk buildid:${17} posturl:$POST_URL
