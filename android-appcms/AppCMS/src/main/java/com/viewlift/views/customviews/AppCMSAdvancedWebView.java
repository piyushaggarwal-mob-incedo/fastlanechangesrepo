...
/*
 * Android-AppCMSAdvancedWebView (https://github.com/delight-im/Android-AppCMSAdvancedWebView)
...
public class AppCMSAdvancedWebView extends WebView {
    ...
    protected AppCMSAdvancedWebView.Listener mListener;
    ...
    public AppCMSAdvancedWebView(Context context) {
        super(context);
        init(context);
    }

    public AppCMSAdvancedWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AppCMSAdvancedWebView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public void setListener(final Activity activity, final AppCMSAdvancedWebView.Listener listener) {
        setListener(activity, listener, REQUEST_CODE_FILE_PICKER);
    }

    public void setListener(final Activity activity, final AppCMSAdvancedWebView.Listener listener, final int requestCodeFilePicker) {
        if (activity != null) {
    ...
    public void setListener(final Fragment fragment, final AppCMSAdvancedWebView.Listener listener) {
        setListener(fragment, listener, REQUEST_CODE_FILE_PICKER);
    }

    public void setListener(final Fragment fragment, final AppCMSAdvancedWebView.Listener listener, final int requestCodeFilePicker) {
        if (fragment != null) {
    ...
    protected void setListener(final AppCMSAdvancedWebView.Listener listener, final int requestCodeFilePicker) {
        mListener = listener;
     ...
     * @param fromUrl the URL of the file to download, e.g. the one from `AppCMSAdvancedWebView.onDownloadRequested(...)`
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        ...
        // if the download manager app has been disabled on the device
            ...
            openAppSettings(context, AppCMSAdvancedWebView.PACKAGE_NAME_DOWNLOAD_MANAGER);
